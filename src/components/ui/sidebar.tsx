  ...
  (
    ...
    if (!mounted) {
        ...
        return (
             <div
                ref={ref}
                className={cn("group hidden md:block text-sidebar-foreground", className)}
            ...
            >
                 <div
                    ...
                    className="flex h-full flex-col bg-sidebar-background group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
                    >
                    {children}
                </div>
            </div>
